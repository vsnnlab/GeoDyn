function [xx, yy] = secdraw(loc_x,loc_y,start_angle, sector_angle, radius,face_color)
...
MaxPts = 36;                   % maximum number of points in a whole circle.
...
if nargout < 2
    hh=patch(xx, yy, face_color,'EdgeColor','k','EdgeAlpha',0,'EraseMode','none');
end